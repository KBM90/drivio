import 'package:drivio_app/driver/services/driver_passenger_services.dart';
import 'package:drivio_app/passenger/models/passenger.dart';
import 'package:flutter/foundation.dart';

class DriverPassengerProvider extends ChangeNotifier {
  ...
  Future<void> getPassenger(int passengerId) async {
    try {
      final passenger = await DriverPassengerService.getPassenger(passengerId);
